...
__CJS__export_default__ = module.exports = __CJS__import__14__.bar.baz;

const routes = [{
  path: '/',
  component: __CJS__import__15__,
}];

if (__CJS__import__16__.bar) {
  const result = __CJS__import__17__.bar.baz();
  if (result) {
    __CJS__export_default__ = module.exports = __CJS__import__18__.bar.baz();
  }
}
