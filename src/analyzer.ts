...
function createAnalyzer(context: Context) {
  ...
  function addImportedProperties(id: string, prop) {
  ...
  function analyzeDeclareImport(node: AcornNodeExt) {
  ...
  function analyzeDeclareExport(node: AcornNodeExt) {
  ...
  function analyzeAssignExportTop(node: AcornNodeExt) {
  ...
  function analyzeAssignExport(node: AcornNodeExt) {
  ...
  function analyzeDynamicImport(node: AcornNodeExt) {
  ...
  function analyzeRequire(node, parent?) {
  ...
  function analyzeExports(node: AcornNodeExt, parent: AcornNodeExt) {
    if (node.name !== 'UnaryExpression' && parent.operator === 'typeof') {
      context.needDefaultObject = true
    }
    context.exportsNodes.push(node)
  }

  function analyzeModule(node: AcornNodeExt) {
  ...
  function analyzeNestedExports(node: AcornNodeExt) {
  ...
  function analyzeCallable(node: AcornNodeExt) {
  ...
  function analyzeTag(node: AcornNodeExt) {
  ...
  function analyzeReassign(node: AcornNodeExt) {
  ...
  function analyzeClass(node: AcornNodeExt) {
  ...
  function analyzeRequireId(node: AcornNodeExt) {
  ...
  function analyzeMemberAccess(node: AcornNodeExt) {
    if (
